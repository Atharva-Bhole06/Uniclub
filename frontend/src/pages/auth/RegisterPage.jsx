...
export default function RegisterPage() {
  ...
  return (
    <>
      ...
      {/* Navbar is position:fixed — must be outside any wrapper */}
      ...
      {/* Transparent centered wrapper — no background */}
          ...
          {step === STEPS.OTP && (
            <>
              ...
              <div style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.9rem' }}>
                ...
                <button type="button" onClick={handleResend} disabled={cooldown > 0} style={{ background: 'none', border: 'none', color: cooldown > 0 ? '#555' : '#c9f28f', cursor: cooldown > 0 ? 'not-allowed' : 'pointer', fontWeight: 'bold' }}>
